...
class TestPageNumberResponse:
    ...
    def test_pagination_schema_return(self, app):
        ...
        assert component_schema == {'type': 'object', 'properties': {'meta': {'$ref': '#/components/schemas/PageNumberMeta'}, 'data': {'type': 'array', 'items': {'$ref': '#/components/schemas/Output'}}}}
...
class TestLimitOffsetResponse:
    ...
    def test_pagination_schema_return(self, app):
        ...
        assert component_schema == {'type': 'object', 'properties': {'meta': {'$ref': '#/components/schemas/LimitOffsetMeta'}, 'data': {'type': 'array', 'items': {'$ref': '#/components/schemas/Output'}}}}
